...
import mycode.axonframework.messaging.eventhandling.AbstractSequencedDomainEventEntry;
...
public class DomainEventEntry extends AbstractSequencedDomainEventEntry<String> {
    ...
    public DomainEventEntry(DomainEventMessage<?> eventMessage, Serializer serializer) {
        super(eventMessage, serializer, String.class);
    }
