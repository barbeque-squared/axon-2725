...
package mycode.axonframework.messaging.eventhandling;
...
public abstract class AbstractSequencedDomainEventEntry<T> extends AbstractDomainEventEntry<T> implements DomainEventData<T> {
    ...
    @Id
    // the two lines below are intentional diff -- see https://github.com/AxonFramework/AxonFramework/issues/2231
    @GeneratedValue(generator = "postgres-bigint-generator")
    @GenericGenerator(name = "postgres-bigint-generator", strategy = "mycode.PostgresBigintGenerator")
